...
class DigitalOcean(Api):
    """
    A client for interacting with the Digital Ocean API.
    Args:
        token (str): The API token used for authenticating requests.
    Attributes:
        token (str): The API token.
        base_url (str): The base URL for the Digital Ocean API.
    Methods:
        process_response(response):
            Processes the HTTP response from the Digital Ocean API.
    ...
    def __init__(self, token):
        ...
        Attributes:
            ...
            base_url (str): The base URL for the Digital Ocean API v2.
        """
        self.token = token
    ...
    def process_response(self, response):
        """
        Processes the API response specific to the Digital Ocean API.
