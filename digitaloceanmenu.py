...
class DigitalOceanMenu():
    ...
    def __init__(self, digitalocean_api, cloudflare_api):
        """
        """
        ...
        # self.obj_os = OS(self.digitalocean_api)          # Initialize Operating System Object
        # self.obj_ap = Application(self.digitalocean_api) # Initialize Application Object
        # self.obj_cf = Zone(self.cloudflare_api)   # Cloudflare Zone Object
        # self.obj_i = Instance(self.digitalocean_api, self.obj_fw, self.obj_ss, self.obj_cf, self.obj_p, self.obj_r, self.obj_os, self.obj_ap) # Vultr Compute Instance Object
    ...
    #         {'id': 8, 'name': 'Delete IP4 DNS Name from Hostname'},
    #         {'id': 9, 'name': 'Create IP4 DNS Name from IP'},
    #         {'id': 10, 'name': 'Create IP6 DNS Name from IP'},
    #         {'id': 11, 'name': 'Go Back'},
    #     ]
    #     option, inst_list = print_input_menu(options, 'What action?: ', 'id', ['name'], False)
    #     match option:
    ...
    #             self.instance()
    #         case '9':
    #             self.obj_i.dns_from_ip4()
    #             self.instance()
    #         case '10':
    #             self.obj_i.dns_from_ip6()
    #             self.instance()
    #         case '11':
    #             self.main_menu()
